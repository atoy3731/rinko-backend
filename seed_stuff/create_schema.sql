CREATE SCHEMA rinko;
	CREATE TABLE rinko.users (id SERIAL PRIMARY KEY, username TEXT UNIQUE NOT NULL, first_name TEXT, last_name TEXT, password TEXT, email TEXT UNIQUE NOT NULL, admin BOOLEAN DEFAULT FALSE);
